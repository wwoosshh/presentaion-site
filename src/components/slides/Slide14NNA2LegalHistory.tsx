  ...
  return (
    <RevealOnView className="relative z-10 w-full max-w-[1100px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-4">
        <div className="bg-bg-2 p-7 border-l-[3px] border-accent">
        ...
        <div className="bg-bg-2 p-7 border-l-[3px] border-text-faint">
      ...
      <BigStat numericValue={70} suffix="%" value={c.bigStat.value} label={c.bigStat.label} />
      <p className="text-[clamp(1.1rem,1.6vw,1.4rem)] mt-2">{c.closing}</p>
    </RevealOnView>
  )
}
