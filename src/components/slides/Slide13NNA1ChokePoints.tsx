  ...
  return (
    <RevealOnView className="relative z-10 w-full max-w-[1100px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
        <div>
          <h4 className="font-serif text-xl mb-2">전략적 통제점 (Choke Points)</h4>
          <ul>
        ...
        <div>
          <h4 className="font-serif text-xl mb-2">미국의 이중 그랜드 전략</h4>
          <ul>
      ...
      <p className="text-[clamp(1rem,1.3vw,1.2rem)] mt-2">미국은 지금 <strong className="text-accent">마한의 처방을 우주에서 실행</strong>하고 있다. 침략이 아니라 합리적 전략이다.</p>
    </RevealOnView>
  )
}
